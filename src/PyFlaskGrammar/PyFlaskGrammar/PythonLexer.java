// Generated from /home/mohee/compiler_project1/src/PyFlaskGrammar/PythonLexer.g4 by ANTLR 4.13.2
...
public class PythonLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"BOOL", "PRINT", "DEF", "RETURN", "IMPORT", "FROM", "AT", "ASSIGN", "COMMA", 
			"DOT", "COLON", "LPARENS", "RPARENS", "LSB", "RSB", "LBK", "RBK", "ADD", 
			"SUB", "MUL", "DIV", "LT", "GT", "LE", "GE", "EQ", "NE", "IF", "ELSE", 
			"FOR", "IN", "WHILE", "VAR", "ID", "NUMBER", "STRING", "NEWLINE", "INDENT", 
			"DEDENT", "WS", "COMMENT"
		};
	}
